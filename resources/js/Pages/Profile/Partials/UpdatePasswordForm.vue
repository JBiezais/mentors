...
<template>
    <section>
        <header>
            <h2 class="text-lg font-medium text-gray-900">Atjaunot paroli</h2>

            <p class="mt-1 text-sm text-gray-600">
                Lai nodrošinātu drošību, pārliecinieties, ka jūsu konts izmanto garu, nejauši izvēlētu paroli.
            </p>
        </header>

        <form @submit.prevent="updatePassword" class="mt-6 space-y-6">
            <div>
                <InputLabel for="current_password" value="Šī brīža parole" />
