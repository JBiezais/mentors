...
<div class="message-box">
    ...
    <p>Vari uzdot jautājumus arī sazinoties ar <strong>{{$contacts['name']}}</strong> <a href="mailto:{{$contacts['email']}}">({{$contacts['email']}})</a> vai rakstot uz <a href="mailto:sp@rsu.lv">sp@rsu.lv</a>.</p>
    <p>
